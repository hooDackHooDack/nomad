...
import ActivityCreateLayout from './_layout';
...
export default function ActivityCreatePage() {
  ...
  const currentStep =
    router.isReady && router.query.steps
      ? Array.isArray(router.query.steps)
        ? router.query.steps[0]
        : router.query.steps
      : 'basic';

  const StepComponent =
    stepComponents[currentStep as StepKey] || stepComponents.basic;
